...
import { signUp ,signIn,addCategory,deleteCategory,viewOrderHistory,viewOrderById, userRemoveById,signOut} from "../controller/admin.controller.js";
...
router.get("/history/view/:id",viewOrderById);
