...
import bookRouters from './routes/book.route.js';
import stateRouters from './routes/state.rout.js';
import cityRouters from './routes/city.route.js';
...
server.use('/books',bookRouters);
server.use('/mausam',stateRouters);
server.use('/cities',cityRouters);
